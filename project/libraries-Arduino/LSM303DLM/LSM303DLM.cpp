...
void LSM303DLM::init(byte device, byte sa0_a)
{	
	_device = device;
	switch (_device)
	{
...
// mode.
void LSM303DLM::enableDefault(void)
{
...
void LSM303DLM::writeAccReg(byte reg, byte value)
{
...
byte LSM303DLM::readAccReg(byte reg)
{
	byte value;
...
void LSM303DLM::writeMagReg(byte reg, byte value)
{
...
byte LSM303DLM::readMagReg(int reg)
{
	byte value;
...
// returned.
int LSM303DLM::heading(vector from)
{
    // shift and scale
...
void LSM303DLM::vector_cross(const vector *a,const vector *b, vector *out)
{
...
float LSM303DLM::vector_dot(const vector *a,const vector *b)
{
  return a->x*b->x+a->y*b->y+a->z*b->z;
}

void LSM303DLM::vector_normalize(vector *a)
{
...
byte LSM303DLM::detectSA0_A(void)
{
