...
LSM303D::LSM303D( void)
{
  ...
  //
  m_min = (LSM303D::vector<int16_t>){-32767, -32767, -32767};
  m_max = (LSM303D::vector<int16_t>){+32767, +32767, +32767};
...
unsigned int LSM303D::getTimeout()
{
  return io_timeout;
}
...
Serial.println( "21");
    ...
    {
	  if (device == device_auto)
		Serial.println( "Returning device = false");

	  if (sa0 == sa0_auto)
	    Serial.println( "Returning sa0 = false");
...
//
void LSM303D::enableDefault(void)
{
...
void LSM303D::readAcc(void)
{
  ...
  while (Wire.available() < 6) {
    ...
    {
      did_timeout = true;
	  Serial.println( "readAcc() timed out.");
      return;
    }
  }
...
void LSM303D::readMag(void)
{
  ...
  while (Wire.available() < 6) {
    ...
    {
      did_timeout = true;
	  Serial.println( "readMag() timed out.");
      return;
    }
  }
...
void LSM303D::vector_normalize(vector<float> *a)
{
